				...
				<div class="panel panel-default">
					<div class="panel-body">
						<h4 style="text-align: center">
							<b>Relatório sobre a Média Salarial e Quantidade de Servidores</b>
						</h4>
						<hr>
						<h5 style="text-align: center">
						...
						<div id=input_cargo class=col-lg-3 style="left:0px; top:0px">
							...
							<input id="cargo2" placeholder="Escolha o segundo cargo" required />
							<h6 style="text-align: left">
								<b>Cargo</b>
							</h6>
							<input id="cargo3" placeholder="Escolha o terceiro cargo"
								required />
								
								
						</div>
						
						<div id=input_categoria class=col-lg-3 style="left:0px; top:0px">
						...
						<div id=input_orgao class=col-lg-3 style="left:0px; top:0px">
						...
						<div id=tipo_de_salario class=col-lg-3
						...
						<div id=datas class=col-lg-3 style="left: 20px; top: 0px">
							<h6 style="text-align: left">
								<b>Janela de Tempo</b>
							</h6>
		...
		$(document).ready(function() {
				...
				if ($('#tipo option:selected').attr('id') == 'cargo') {
					...
					$.ajax({
						...
						success : function(data) {
							...
							awesomplete2.list = data;

							var input3 = document
									.getElementById("cargo3");
							var awesomplete3 = new Awesomplete(input3,
									{
										minChars : 1,
										autoFirst : true,
										maxItems : 10
									});
							awesomplete3.list = data;
			...
			function showdatas() {
				...
				if ($('#data_selecionada option:selected').attr('id') == 'data_2014') {
					...
					var input2 = $('#cargo2').val();
					var input3 = $('#cargo3').val();
