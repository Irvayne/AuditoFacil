...
public class AlgoritmoBusca {
	...
	/**
	 * Metodo que processa as informacoes vindas da dao e monta o grafico para
	 * view da funcionalidade media salarial qnt de servidores
	 * 
	 * @param dados
	 *            - dados vindos da view
	 * @return - grafico a ser exibido na view
	...
	/**
	 * Metodo que monta um grafico com informacoes vindas da dao para a
	 * funcioanlidade media salarial
	 * 
	 * @param dados
	 *            - dados vindos da view
	 * @return - grafico de linha com a media salarial
	 * @throws SQLException
	 */
